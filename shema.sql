...
CREATE TABLE "e_bikes" (
    "id" INTEGER,
    -- "current_rental_location_id" INTEGER,
    "battery_id" INTEGER,
    "latest_location_history_id" INTEGER,
    -- "currently_rented" INTEGER NOT NULL CHECK ("currently_rented" IN (0,1)), -- BOOL
    "photo" BLOB,
    PRIMARY KEY("id"),
    -- FOREIGN KEY("current_rental_location_id") REFERENCES "rental_location"("id"),
...
CREATE TABLE "batteries" (
    ...
    -- "currently_charging" INTEGER NOT NULL CHECK ("currently_charging" IN (0,1)), -- BOOL,
    "photo" BLOB,
    PRIMARY KEY("id")
);
...
VALUES
(1, NULL, "47.050257","8.309755"),
(2, NULL, "47.051867","8.302921"),
(7, NULL, "47.052676","8.304137"),
(12, NULL, "47.048533","8.303985"),
(13, NULL, "46.955874","8.277111");
